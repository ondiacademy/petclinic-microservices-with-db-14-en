...
AWS_REGION=$AWS_REGION helm repo add stable-petclinic s3://petclinic-helm-charts-ondia/stable/myapp/ || echo "repository name already exists"
...
kubectl create secret generic regcred -n petcl{inic-prod-ns \
